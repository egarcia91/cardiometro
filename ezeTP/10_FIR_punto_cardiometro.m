...
figure;
pzmap(tf(b,a));
print -djpg imagenes/punto_10_FIR_Polos_Ceros.jpg; %Octave
grid minor;
...
print -djpg imagenes/punto_10_FIR_diagrama_filtro.jpg; %Octave
grid minor;
...
ylim([-0.06 0.15]);
print -djpg imagenes/punto_10_FIR_respuesta_impulso.jpg; %Octave
grid minor;
...
print -djpg imagenes/punto_10_FIR_fft.jpg; %Octave
grid minor;
...
print -djpg imagenes/punto_10_FIR_filtrado_sobremuestreo.jpg; %Octave
grid minor;
...
xlabel('t [s]');
print -djpg imagenes/punto_10_FIR_mas_definicion.jpg; %Octave
grid minor;
